...
public:
    ...
    */
    ...
    WiFiManagerParameter(const String& custom);
    WiFiManagerParameter(const String& id, const String& label);
    WiFiManagerParameter(const String& id, const String& label, const String& defaultValue, int length);
    WiFiManagerParameter(const String& id, const String& label, const String& defaultValue, int length, const String& custom);
    WiFiManagerParameter(const String& id, const String& label, const String& defaultValue, int length, const String& custom, int labelPlacement);
    WiFiManagerParameter(const String& id, const String& label, const int defaultValue, int length);
    WiFiManagerParameter(const String& id, const String& label, const int defaultValue, int length, const String& custom);
    WiFiManagerParameter(const String& id, const String& label, const int defaultValue, int length, const String& custom, int labelPlacement);
    ...
    const String& getPlaceholder() const; // @deprecated, use getLabel
    bool getValueBool() const;
    int getValueInt() const;
    int         getValueLength() const;
    int         getLabelPlacement() const;
    virtual const String& getCustomHTML() const;
    void        setValue(const String& defaultValue);

protected:
    void init(const String& id, const String& label, const String& defaultValue, int length, const String& custom, int labelPlacement);
...
public:
    ...
    void          setCustomHeadElement(const String& element);
    ...
    void          setMenu(const String menu[], uint8_t size);
    ...
    const String GetConfigSSID()const;
    const  String GetConfigPassword()const;
    // get hostname helper
...
private:
    ...
    std::vector< String> _menuIdsParams = { "wifi","param","info","exit" };
    std::vector< String> _menuIdsUpdate = { "wifi","param","info","update","exit" };
    std::vector< String> _menuIdsDefault = { "wifi","info","exit","sep","update" };
...
// parameter options
    ...
    String _customHeadElement = ""; // store custom head element html from user
