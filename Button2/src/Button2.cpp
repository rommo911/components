...
Button2::Button2() :Task("Button2",4096,1,tskNO_AFFINITY,false) {
  pin = UNDEFINED_PIN;
}

/////////////////////////////////////////////////////////////////

Button2::Button2(uint8_t attachTo, uint8_t buttonMode /* = INPUT_PULLUP */, bool isCapacitive /* = false */, bool activeLow /* = true */) :Task("Button2",4096,1,tskNO_AFFINITY,false) {
